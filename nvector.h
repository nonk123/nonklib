...
struct nvector
{
  ...
  unsigned int elt_size; /* the size of one element in bytes */
};
...
#define nv_value(simple_type) nv_generic (simple_type, simple_type, *)
...
int
nv__init (nvector*, size_t initial_length, size_t elt_size);
int
nv__insert (nvector*, unsigned int elt_size, size_t pos, char* value);
int
nv__set (nvector*, unsigned int elt_size, size_t pos, char* value);
int
nv__pushb (nvector*, unsigned int elt_size, char* value);
